    ...
    <>
      ...
      <main className="collection">
        <div className="watch-size">
          <img src="./img/next.png" className="arrow" />
          <img src="./img/hero-img-small.png" alt="img" className="watch1" />
          <img src="./img/hero-img.png" alt="img" className="watch2" />
        </div>
